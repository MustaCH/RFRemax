export const WhoamiCard = () => {
    return (
        <div className="flex flex-col gap-8 md:gap-0 md:flex-row justify-evenly items-center">
            <div className="rounded-full border-4 border-white bg-cover bg-[center_bottom] shadow-lg bg-[url(https://res.cloudinary.com/dfuru6l6d/image/upload/v1732294268/Romina-04_fpifqe.jpg)] w-80 h-80 md:w-96 md:h-96">
            </div>
