...
export const WelcomeBanner = () => {
    ...
    return (
        <div id="welcome-banner" className={`${alloverFont.variable} w-full h-[80vh] md:h-[113vh] mt-2 md:mt-3 bg-cover bg-center md:bg-[center_top_-12rem] bg-[url(https://res.cloudinary.com/dfuru6l6d/image/upload/v1732221175/bannerwelcome_liywcy.jpg)]`}>
