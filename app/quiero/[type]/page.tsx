...
async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
  ...
  return (
    <>
      ...
      <section>
        <div className="flex flex-col gap-6 text-center">
          <div className="flex flex-col gap-6 max-w-2xl mx-auto">
            <h1 className="text-3xl lg:text-4xl font-semibold text-slate-800 text-shadow-sm">{`${type === 'vender' ? 'Vendé' : 'Alquilá'} tu propiedad con una agente experta`}</h1>
            <p className="text-xl text-slate-800 text-shadow-lg">Asegurá el éxito y evitá complicaciones, Romina Frola se encarga de todo el proceso por vos.</p>
            <div className="flex justify-center w-full">
              <div className="flex flex-col gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-xl font-semibold text-slate-800 text-shadow-lg">Al mejor valor</h3>
                </div>
                <div className="flex items-center gap-2">
                  <div className="rounded-full bg-[#4088e3] p-2 w-fit">
                    <FaCheck className="text-white"/>
                  </div>
                  <h3 className="text-xl font-semibold text-slate-800 text-shadow-lg">En tiempo récord</h3>
                </div>
                <div className="flex items-center gap-2">
                  <div className="rounded-full bg-[#4088e3] p-2 w-fit">
                    <FaCheck className="text-white"/>
                  </div>
                  <h3 className="text-xl font-semibold text-slate-800 text-shadow-lg">Sin complicaciones</h3>
                </div>
              </div>
            </div>
            <div className="grid grid-cols-2 max-w-xl mx-auto gap-4">
              <a href="#form" className="text-sm md:text-lg bg-green-500 hover:bg-green-600 duration-150 text-white font-semibold px-6 py-4 rounded-lg capitalize shadow-lg">{type} mi propiedad</a>
              <a href="#whoami" className="text-sm md:text-lg bg-blue-500 hover:bg-blue-600 duration-150 text-white font-semibold px-6 py-4 rounded-lg capitalize shadow-lg">Más información</a>
            </div>
          </div>
          <article className="flex flex-col gap-6 mb-12">
            <h2 className="text-3xl lg:text-4xl font-semibold text-white text-shadow-lg">Proceso transparente 360°</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 w-full gap-4 md:gap-6">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <h3 className="text-3xl font-semibold text-white">Producción</h3>
                <p className="text-white text-md">Recopilamos toda la información necesaria sobre tu propiedad y generamos el contenido para su publicación y difusión</p>
              </div>
              <div className="flex flex-col items-center gap-4">
                <div className="bg-slate-200 p-4 rounded-full shadow-lg"> 
                ...
                <p className="text-white text-md">Encontramos al comprador ideal, negociamos  según tu objetivo y concretamos la venta de tu propiedad</p>
              </div>
            </div>
          </article>
        </div>
      </section>
      <section id="whoami" className="mb-12">
         <div className="flex flex-col md:flex-row-reverse gap-8 justify-evenly items-center">
              <div className="rounded-full border-4 border-white bg-cover bg-center shadow-lg bg-[url(https://res.cloudinary.com/dfuru6l6d/image/upload/v1745614226/whoami2_kqbnke.webp)] w-72 h-72 md:w-96 md:h-96">
              </div>
              <div className="flex flex-col gap-4 bg-white md:text-slate-800 rounded-lg p-8 w-full shadow-lg md:w-1/2">
      ...
      <section className="h-full lg:grid lg:grid-cols-2 mt-2">
